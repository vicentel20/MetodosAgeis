...
describe('TelaLoginComponent', () => {
  ...
  it('Teste com nome do acolhido em branco', () => {
    expect(component.validaDados("","12345678988","20jan2021","Maria",3)).toBe("Favor revisar o nome do novo acolhido");
  });

  it('Teste com nome do acolhido muito curto', () => {
    expect(component.validaDados("A","12345678988","20jan2021","Maria",3)).toBe("Favor revisar o nome do novo acolhido");
  });

  it('Teste com nome do acolhido contendo caracteres inválidos', () => {
    expect(component.validaDados("Marcel Aldimir%","12345678988","20jan2021","Maria",3)).toBe("Favor revisar o nome do novo acolhido");
  });

  /************ Testa entradas inválidas para o CPF do acolhido ************/
  it('Teste com CPF do idoso em branco', () => {
    expect(component.validaDados("Marcel Aldimir","           ","20jan2021","Maria",3)).toBe("Favor revisar o CPF do acolhido");
  });

  it('Teste com CPF do idoso muito curto', () => {
    expect(component.validaDados("Marcel Aldimir","1234567898","20jan2021","Maria",3)).toBe("Favor revisar o CPF do acolhido");
  });

  it('Teste com CPF do idoso com código de validação inválido', () => {
    expect(component.validaDados("Marcel Aldimir","34485861024","20jan2021","Maria",3)).toBe("Favor revisar o CPF do acolhido");
  });
  ...
  it('Teste com data de nascimento do idoso inválida', () => {
    expect(component.validaDados("Marcel Aldimir","34485861023","30feb1950","Maria",3)).toBe("Data de nascimento é inválida");
  });

  /************ Testa entradas inválidas para o campo de reponsaveis legais ************/
  it('Teste com o nome do responsável em branco', () => {
    expect(component.validaDados("Marcel Aldimir","34485861023","25feb1950","",3)).toBe("Favor revisar o nome do responsável legal");
  });

  it('Teste com o nome do responsável muito curto', () => {
    expect(component.validaDados("Marcel Aldimir","34485861023","25feb1950","A",3)).toBe("Favor revisar o nome do responsável legal");
  });

  it('Teste com o nome do responsável contendo caracteres inválidos', () => {
    expect(component.validaDados("Marcel Aldimir","34485861023","25feb1950","Ezequel Maciel@",3)).toBe("Favor revisar o nome do responsável legal");
  });

  /************ Testa entradas de numero de bens  ************/
  it('Teste com quantidade de bens negativos', () => {
    expect(component.validaDados("Marcel Aldimir","34485861023","25feb1950","Ezequel Maciel",-1)).toBe("Favor revisar a quantidade de bens");
  });

  /************ Testa entradas válidas  ************/
  it('Teste com dados válidos 1', () => {
    expect(component.validaDados("Alfredo Jose","34485861023","25feb1950","Ezequel Maciel",1)).toBe("Dados de cadastro aprovados");
  });

  it('Teste com dados válidos 2', () => {
    expect(component.validaDados("Marcel Aldimir","34485861023","25feb1920","João Rodolfo",2)).toBe("Dados de cadastro aprovados");
  });
